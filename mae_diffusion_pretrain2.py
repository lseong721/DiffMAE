...
if __name__ == '__main__':
    ...
    accelerate = Accelerator(log_with='tensorboard', project_dir='logs')
    ...
    model, optim, dataloader = accelerate.prepare(model, optim, dataloader)
    ...
    for e in range(args.total_epoch):
        ...
        for batch in bar:
            ...
            bar.set_description('[Epoch: %d] loss: %.08f' % (e, avg_loss))
