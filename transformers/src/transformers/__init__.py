...
_import_structure = {
    ...
    ######################
    "models.vit_diffmae": ["VIT_DiffMAE_PRETRAINED_CONFIG_ARCHIVE_MAP", "ViTDiffMAEConfig"],
    ######################
...
try:
    ...
    #########################
    _import_structure["models.vit_diffmae"].extend(
        [
...
if TYPE_CHECKING:
    ...
    from .models.vit_diffmae import VIT_DiffMAE_PRETRAINED_CONFIG_ARCHIVE_MAP, ViTDiffMAEConfig
    ...
    try:
        ...
        from .models.vit_diffmae import (
            VIT_DiffMAE_PRETRAINED_MODEL_ARCHIVE_LIST,
            ViTDiffMAEForPreTraining,
            ViTDiffMAELayer,
            ViTDiffMAEModel,
