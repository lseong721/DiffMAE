...
from transformers import ViTDiffMAEConfig, ViTDiffMAEForPreTraining, ViTDiffMAEImageProcessor
...
def convert_vit_mae_checkpoint(checkpoint_url, pytorch_dump_folder_path):
    ...
    model = ViTDiffMAEForPreTraining(config)

    state_dict = torch.hub.load_state_dict_from_url(checkpoint_url, map_location="cpu")["model"]

    image_processor = ViTDiffMAEImageProcessor(size=config.image_size)
