...
class ViTDiffMAEModel(ViTDiffMAEPreTrainedModel):
    ...
    def forward(
        ...
        len_output = embedding_output.shape[1]
        len_noise = embedding_noise.shape[1]
        embedding_output = torch.cat([embedding_output, embedding_noise], dim=1)
        #################################
...
class ViTDiffMAEForPreTraining(ViTDiffMAEPreTrainedModel):
    ...
    def forward(
        ...
        latent_noise = outputs.last_hidden_state_noise
        ids_restore = outputs.ids_restore
        mask = outputs.mask
        noise = outputs.noise
